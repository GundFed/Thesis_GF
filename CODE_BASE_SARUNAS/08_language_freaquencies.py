...
STOPWORDS = {
    ...
    "well","were","which","while","whither","whom","whose","will",
...
INPUT_FILES = {
    #"ru": Path(__file__).parent / "DATA" / "03_ru_sarunas.csv",
    "de": Path(__file__).parent / "DATA" / "03_de_sarunas.csv",
    #"en": Path(__file__).parent / "DATA" / "03_eng_sarunas.csv",
}
