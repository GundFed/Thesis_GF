...
input_path = Path(__file__).parent / "DATA" / "02_lv_main.csv"
stopword_file = Path(__file__).parent / "DATA" / "stop_words_latvian.txt"
output_path = Path(__file__).parent / "DATA" / "03_lv_main_cleaned.csv"
